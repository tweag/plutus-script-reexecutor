...
-- NOTE: For some reason fourmolu breaks on this file. If you make changes to
-- this file, please disable the commit hook before committing.

-- NOTE: This module is copied from cooked-validators:Cooked.ShowBS
...
module Onchain.V3.ShowBS (ShowBS (..)) where
